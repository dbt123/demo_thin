    ...
    <div style="float:left;" class="title_form">
        <?php if($cate): ?> 
          ...
          <?php if(session('admin')->can(['dang_bai_viet']) || session('admin')->can(['luu_bai_viet'])): ?>
            ...
            <a href="<?php echo e(route('posts.add')); ?>" class="p-themmoi1">+ Thêm bài viết</a>
         
           <?php endif; ?>
        <?php else: ?>
           <?php if(session('admin')->can(['dang_bai_viet']) || session('admin')->can(['luu_bai_viet'])): ?>
          
            <a href="<?php echo e(route('posts.add')); ?>" class="p-themmoi" style="margin-left:0px">+ Thêm bài viết</a>
          ...
          <table class="table m-b-none" ui-jp="footable" data-filter="#filter" data-page-size="10">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td><a class="_link" href="<?php echo e(Route('blog', ['alias' => $value->slug, 'id'=>$value->id])); ?>"><?php echo e($value->title); ?></a></td>
                  <?php else: ?>
                  <td><?php echo e($value->title); ?></td>
                  <?php endif; ?>
                  <td><img src="<?php echo e($value->thumb_images); ?>" style="height:30px"></td>
                 <!--  <td>
              ...
              <tr>
                  <td colspan="12" class="text-center">
                   <ul class="list-inline comment-pagination">
                            <?php $link_limit = 9; ?>
                              <?php for($i = 1; $i <= $list_bai_viet->lastPage(); $i++): ?>
                                        <?php
                                        ...
                                        ?>
                                        <?php if($from < $i && $i < $to): ?>
                                            <li class="<?php echo e(($list_bai_viet->currentPage() == $i) ? ' active' : ''); ?>">
                                                <a  class="<?php echo e(($list_bai_viet->currentPage() == $i) ? ' active' : ''); ?>" href="<?php echo e($list_bai_viet->url($i)); ?>" data-page=<?php echo e($i); ?>><?php echo e($i); ?></a>
                                            </li>
                                        <?php endif; ?>
                              <?php endfor; ?>
                        </ul>
