            ...
            <div class="col-md-8 col-sm-8 col-xs-12">
                ...
                <div class="gb-listservicerecent">
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo e(Route('blog', ['id'=>$post->id, 'slug'=>$post->slug])); ?>"><img src="https://bizweb.dktcdn.net/100/297/763/themes/645555/assets/rightnp.png?1525253656971" style="height: 12px; width: 14px;"><?php echo e($post->title); ?></a></li>
                        <?php endforeach; ?>
