...
<div class="navbar">
    <div style="float:left;" class="title_form">
        <?php if($cate): ?> 
          <p style="float: left;"><?php echo e($cate->name); ?></p>
          <?php if(session('admin')->can('them_san_pham') || session('admin')->can('luu_san_pham')): ?>
              <a href="<?php echo e(route('product.create.product')); ?> " class="p-themmoi1">+ Thêm sản phẩm</a>
            <?php endif; ?>
        <?php else: ?>
          <p>
          <!-- phong -->
            <?php if(session('admin')->can('them_san_pham') || session('admin')->can('luu_san_pham')): ?>
              <a href="<?php echo e(route('product.create.product')); ?> " class="p-themmoi"  style="margin-left:0px">+ Thêm sản phẩm</a>
            <?php endif; ?>
          </p>
        <?php endif; ?>
        
    </div>
    <?php if(session('admin')->can('cau_hinh_email_het_hang_san_pham')): ?>
    ...
    <div class="padding">
      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <form action="<?php echo route('search.product'); ?>" method="get">
          ...
          <div class="dropdown-menu pull-right">
                    ...
                    <a  class="dropdown-item" href="<?php echo e(route('folder.product',['id'=>$v0->id])); ?>"><?php echo e($v0->name); ?></a>
                      <?php if($v0->subcategory): ?>
                           <?php foreach($v0->subcategory as $v1): ?>
                                <a  class="dropdown-item"  href="<?php echo e(route('folder.product',['id'=>$v1->id])); ?>"><?php echo e($space); ?> <?php echo e($v1->name); ?></a>
                                <?php if($v1->subcategory): ?>
                                  <?php foreach($v1->subcategory as $v2): ?>
                                    <a  class="dropdown-item"  href="<?php echo e(route('folder.product',['id'=>$v2->id])); ?>"><?php echo e($space.$space); ?> <?php echo e($v2->name); ?></a>
                                        <?php if($v2->subcategory): ?>
                                        <?php foreach($v2->subcategory as $v3): ?>
                                          <a  class="dropdown-item" href="<?php echo e(route('folder.product',['id'=>$v3->id])); ?>"><?php echo e($space.$space.$space); ?> <?php echo e($v3->name); ?></a>
                                          <?php if($v3->subcategory): ?>
                                             <?php foreach($v3->subcategory as $v4): ?>
                                              <a  class="dropdown-item" href="<?php echo e(route('folder.product',['id'=>$v4->id])); ?>"><?php echo e($space.$space.$space.$space); ?> <?php echo e($v4->name); ?></a>
                                             <?php endforeach; ?>
                                         <?php endif; ?>
                                         <?php endforeach; ?>
                                     <?php endif; ?>
        ...
        <div class="d-dstt" <?php if(sizeof($attribute_count)): ?> style="border-top:1px solid #F9FAFA;" <?php endif; ?>>
                <?php $name_attr = ""; $list_filter = array(); $arr_filter = array()?>
                <?php foreach($attribute_count as $k => $v): ?>
                        <?php if($v['name'] != $name_attr): ?>
                            <?php if($v->avaiable == 1): ?>
                                <?php $list_filter = App\Filter::where('name',$v->name)->get(); ?>
                                <?php foreach($list_filter as $kx => $filter_2): ?>
                            ...
                            <div class="d-dstt-row">
                                <p>
                                <span class="d-dstt-row-title"><?php echo e($v['name']); ?> :</span>
                        <?php endif; ?>
                        <?php if(isset($attribute_count[$k+1])): ?>
                          <?php if($v->avaiable == 1): ?>
                            <?php if($attribute_count[$k+1]->name != $attribute_count[$k]->name): ?>
                                <?php foreach($list_filter as $kx => $filter_2): ?>
                                    <?php if( $v->value <= $filter_2->max && $v->value > $filter_2->min ): ?>
                                    ...
                                    <?php endif; ?>
                                <?php endforeach; ?>
                                <?php foreach($list_filter as $filter_2): ?>
                                    <?php if( ( $filter_2->number_public + $filter_2->number_hidden) >0 ): ?>
                                    <span class="d-dstt-row-name"><?php if($filter_2->config_name): ?> <?php echo e($filter_2->config_name); ?> <?php else: ?> <?php echo e($filter_2->min); ?> - <?php echo e($filter_2->max); ?> <?php endif; ?><span class="slsptt"> [<?php echo e($filter_2->number_public); ?>/<?php echo e($filter_2->number_hidden); ?>]</span></span>
                                    <?php endif; ?>
                                <?php endforeach; ?>
                                </p>
                                </div>
                          ...
                          <?php else: ?>
                            <?php if($attribute_count[$k+1]['name'] != $attribute_count[$k]['name']): ?>
                                <?php if($v->show): ?>
                                <span class="d-dstt-row-name"><?php echo e($v['value']); ?><span class="slsptt"> [<?php echo e($v['num']); ?>/<?php echo e($v['num_hide']); ?>]</span></span>
                                <?php endif; ?>
                                </p>
                            </div>
                            <?php else: ?>
        ...
        <div class="table-responsive">
            ...
            <tbody id="list_frame">
              <?php foreach($list_san_pham as $key2 => $value2): ?>
              <?php
              ...
              ?>
                <?php foreach($frame_x as $key => $value): ?>
                <tr <?php if($key2%2 == 0): ?> style="background-color:rgb(246,246,246)" <?php endif; ?>>
                   <td><a href="<?php echo e(route('getProDetail',['id'=>$value->id,'slug'=>$value->slug])); ?>"><?php echo $value->name; ?> </a></td>
                   <td><?php echo $value->code_frame; ?></td>
                   <td style="padding:5px"><a href="<?php echo e(route('getProDetail',['id'=>$value->id,'slug'=>$value->slug])); ?>"><img  src="<?php echo asset($value->thumb_images); ?>" alt="" style="width:auto;height:37px;"></a></td>
                   
                   <td id="d-edit-so-luong" style="cursor:pointer;padding-left:38px;" data-id="<?php echo $value->id; ?>"><?php echo $value->sku; ?></td>
                   <td>
                    <?php if($value->status == 1): ?>
                      <span style="color:#009D17;" class="d-status">
                        <i class="material-icons " data-status="<?php echo $value->status; ?>" data-id="<?php echo $value->id; ?>"  style="padding-left: 17px; font-size:20px;">&#xe80b;</i>
                      </span>
                    <?php endif; ?>
                   ...
                   <td id="d-label-list" class="d-edit-true_<?php echo $value->id; ?>" data-id="<?php echo e($value->id); ?>">
                    <?php if($value->label == 0): ?>
                   ...
                   <td class="action-post color1" style="padding: 7px 5px 5px 5px;">
                    <a href="<?php echo route('frame.edit.frame',['id'=>$value->id]); ?>">
                      Sửa
                    </a>
                    <a href="#" type="submit" id="xoa-sp-f" data-id="<?php echo e($value->id); ?>">
                      Xóa
                    </a> 
                     <a href="<?php echo route('frame.create.frame',['id'=>$value->id]); ?>" style="font-size:17px; padding: 0 4px 3px 4px;"><i class="material-icons" style="vertical-align: -4px;">&#xe148;</i></a> 
                   </td>
                   <?php 
                   ...
                   ?>
                   <td id="321">
                    <?php if($since_start->m > 0): ?>
                        <span class="time-date"><<?php echo e($since_start->m." tháng trước"); ?>  bởi /span>
                        <a href="#"  data-time="<?php echo $value->updated_at; ?>" style="color:#738CEC"><?php if($value->last_edit_by_u == 0): ?> <?php echo $value->create_by_u; ?> <?php else: ?> <?php echo e($value->last_edit_by_u); ?> <?php endif; ?></a>
                    <?php else: ?>
                      <?php if($since_start->d > 0): ?>
                        <span class="time-date"><?php echo e($since_start->d." ngày trước"); ?>  bởi</span> 
                        <a href="#"  data-time="<?php echo $value->updated_at; ?>" style="color:#738CEC"><?php if($value->last_edit_by_u == 0): ?> <?php echo $value->create_by_u; ?> <?php else: ?> <?php echo e($value->last_edit_by_u); ?> <?php endif; ?></a>
                      <?php else: ?>
                          <?php if($since_start->h > 0): ?>
                            <span class="time-date"><?php echo e($since_start->h." giờ trước"); ?>  bởi </span>
                            <a href="#"  data-time="<?php echo $value->updated_at; ?>" style="color:#738CEC"><?php if($value->last_edit_by_u == 0): ?> <?php echo $value->create_by_u; ?> <?php else: ?> <?php echo e($value->last_edit_by_u); ?> <?php endif; ?></a>
                          <?php else: ?>
                            <?php if($since_start->i >0): ?>
                              <span class="time-date"><?php echo e($since_start->i." phút trước"); ?> bởi </span>
                              <a href="#"  data-time="<?php echo $value->updated_at; ?>" style="color:#738CEC"><?php if($value->last_edit_by_u == 0): ?> <?php echo $value->create_by_u; ?> <?php else: ?> <?php echo e($value->last_edit_by_u); ?> <?php endif; ?></a>
                            <?php else: ?>
                                <span class="time-date"><?php echo "Vừa xong"; ?> bởi</span>
                                <a href="#"  data-time="<?php echo $value->updated_at; ?>" style="color:#738CEC"><?php if($value->last_edit_by_u == 0): ?> <?php echo $value->create_by_u; ?> <?php else: ?> <?php echo e($value->last_edit_by_u); ?> <?php endif; ?></a>
                            <?php endif; ?>  
                          <?php endif; ?>    
                      <?php endif; ?>    
              ...
              <tr>
                  <td colspan="12" class="text-center">
                    <ul class="list-inline comment-pagination">
                      <?php $link_limit = 9; ?>
                        <?php for($i = 1; $i <= $list_san_pham->lastPage(); $i++): ?>
                          <?php
                          ...
                          ?>
                          <?php if($from < $i && $i < $to): ?>
                              <li class="<?php echo e(($list_san_pham->currentPage() == $i) ? ' active' : ''); ?>">
                                  <a  class="<?php echo e(($list_san_pham->currentPage() == $i) ? ' active' : ''); ?>" href="<?php echo e($list_san_pham->url($i)); ?>" data-page=<?php echo e($i); ?>><?php echo e($i); ?></a>
                              </li>
                          <?php endif; ?>
                        <?php endfor; ?>
                    </ul>
...
<div id="so-luong-sp" class="modal fade animate" data-backdrop="true" >
   <div class="modal-dialog" id="animate">
       <div class="modal-content" >
            <div  id="d-html">
                  <?php /* dữ liệu ajax đổ ra */ ?>
            </div>
       </div>
    </div>   
</div>
<?php /* end popup số lượng */ ?>

<?php /* popup config het hang */ ?>
 ...
 $(document).ready(function(){
  ...
  $(document).on('click','#d-label-list',function(e){
    ...
    $('#popup-label-list').modal('show');
      $.ajax({
        ...
        type:"post",
        url:"<?php echo e(route('ajax.get.label')); ?>",
        data:{'id':id},
  ...
  $(document).on('click','.d-click-choose',function(){
    ...
    $.ajax({
        ...
        type:"post",
        url:"<?php echo e(route('ajax.edit.label')); ?>",
  ...
  <?php if(session('admin')->can('them_san_pham')): ?>
    ...
    $.ajax({
      ...
      type:"post",
      url:"<?php echo e(route('ajax.edit.list.status')); ?>",
  ...
  $(document).on('click', '#d-popup-config-het-hang', function(event) {
    ...
    $.ajax({
      ...
      type:"post",
      url:"<?php echo e(route('d.ajax.config.hethang')); ?>",
      data:{},
      success:function(data){
        if(data.status == true){
  ...
  $(document).on('submit','#d-submit-config-hethang',function(e){
    e.preventDefault()
      ...
      $.ajax({
        ...
        type:"post",
        url:"<?php echo e(route('ajax.form.email.hethang')); ?>",
        data: formData,
        contentType: false,
        processData: false,
        success:function(data){
  ...
  $(document).on('click','#d-edit-so-luong',function(){
    ...
    $.ajax({
      ...
      type:"post",
      url:"<?php echo e(route('d.edit.sku')); ?>",
      data:{'id':id},
      success:function(data){
  ...
  $(document).on('click','.d-paginate-ul-nhap-kho',function(e){
    ...
    $.ajax({
      ...
      type:"post",
      url:"<?php echo e(route('ajax.phan.trang.nhap.kho')); ?>",
  ...
  $(document).on('submit','#d-form-nhap-kho',function(e){
    e.preventDefault();
      ...
      $.ajax({
        ...
        type:"post",
        url:"<?php echo e(route('ajax.form.nhap.kho')); ?>",
        data: formData,
        contentType: false,
        processData: false,
        success:function(data){
