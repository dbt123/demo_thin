      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <div class="dropdown-menu pull-right">
             <a  class="dropdown-item" href="<?php echo e(route('comments.post.list')); ?>">Chưa duyệt</a>
             <a  class="dropdown-item" href="<?php echo e(route('comments.post.list.done')); ?>">Đã duyệt</a>
            
          </div>

          <button class="number-post"><?php echo e(sizeof($comments)); ?> BL</button>
          ...
          <table class="table m-b-none" ui-jp="footable" data-filter="#filter" data-page-size="10">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>
                  <div style="min-width:80px;color:#7f7f7f"><?php for($i=0;$i< intval($value->rating);$i++): ?>
                  <i class="fa fa-star t-blue-text"></i>
                  <?php endfor; ?>
                  </div>
                  </td>
                  <td><a style="" href="<?php echo e(route('frontend.bai-viet.slug',['id'=>$value->post_id,'slug'=>$value->slug])); ?>" target="_blank"><?php echo e($value->title); ?></a></td>
                  <td class="action-post" >
                    <div style="min-width:140px">
                      <a class="duyet" href="#" data-id="<?php echo e($value->id); ?>">
                      Duyệt
                      </a>
                      <a class="xoa" href="#" data-id="<?php echo e($value->id); ?>">
                      Xóa
                      </a>
                      <a href="<?php echo e(route('posts.edit',['id'=>$value->post_id])); ?>" target="_blank">
                      SP
                      </a>
                    </div>
                  </td>
                       ...
                       <ul class="list-inline comment-pagination">
                                <?php $link_limit = 9; ?>
                                  <?php for($i = 1; $i <= $comments->lastPage(); $i++): ?>
                                            ...
                                            ?>
                                            <?php if($from < $i && $i < $to): ?>
                                                <li class="<?php echo e(($comments->currentPage() == $i) ? ' active' : ''); ?>">
                                                    <a  class="<?php echo e(($comments->currentPage() == $i) ? ' active' : ''); ?>" href="<?php echo e($comments->url($i)); ?>" data-page=<?php echo e($i); ?>><?php echo e($i); ?></a>
                                                </li>
                                            <?php endif; ?>
                                  <?php endfor; ?>
                            </ul>
...
function xacnhanxoa(msg){
 ...
 $(document).on('click', '.duyet', function(event){
    ...
    if(click_duyet==0){
        ...
        $.ajax({
          type: 'post',
          url:  "<?php echo e(route('comments.post.accept')); ?>",
          data: { 'id' : id},
     ...
     if(xacnhanxoa('Bạn có muốn xóa comment này không?')===false){
      ...
      if(click_del==0){
        click_del = 1;
         $.ajax({
             type: 'post',
             url:  "<?php echo e(route('comments.post.delete')); ?>",
             data: {'id': id},
             dataType:'json',
             success: function(data){
                click_del = 0;  
