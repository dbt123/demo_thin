                            ...
                            <input type="hidden" value="{{csrf_token()}}" name="_token">
                             <div class="form-group" >
                                    <div class="form-group">
                                          ...
                                          <div class="col-sm-10">
                                                <input type="text" placeholder="Tên khách hàng" class="form-control thong-tin" name="full_name" > 
                                          </div>                       
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                          ...
                                          <div class="col-sm-10">
                                               <input style="" type="text" class="form-control thong-tin"  placeholder="Ghi chú" name="note" value=""> 
                                          </div>                       
                                    </div> 
