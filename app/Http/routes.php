...
Route::get('/',['as' => 'index','uses' => 'frontend\PageController@getHome']);

Route::get('/blog/{alias}-{id}'.'.aspx',['as'=>'blog','uses'=>'frontend\PageController@getBlog']);
Route::get('/danh-muc-bai-viet/{alias}-{id}', ['as'=>'category.blog','uses'=>'frontend\PageController@showCategory']);
Route::post('dlkasdl', ['as' => 'post.form', 'uses' => 'frontend\PageController@postForm']);
...
Route::group(['prefix'=>'quan-tri', 'middleware'=>'permission'],function(){	
		...
		Route::get('tu-van', ['as' => 'tu.van', 'uses' => 'backend\ContactController@getHome']);
        ...
        Route::group(['prefix'=>'/admin'],function(){
		 ...
		 Route::group(['prefix'=>'/san-pham'],function(){
            ...
            // Danh mục sản phẩm
       		...
       		Route::get('tai-khoan-khach-hang', ['as' => 'list.acc.view', 'uses' => 'backend\AccProController@listacc']);
       		Route::get('tai-khoan-khach-hang/tim-kiem', ['as' => 'search.acc.view', 'uses' => 'backend\AccProController@searchacc']);
       		Route::post('luot-viewasdkakld', ['as' => 'history.view.product', 'uses' => 'backend\AccProController@historyview']);
       });
});